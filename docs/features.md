...
- **Walking around furniture**: paths leave room for heads beside chairs, counters and plant leaves; people leave their desk by the chair's approach side, and follow the aisle through the final turn to their destination. Returning from a celebration plans a fresh route, and going away cancels a perk visit. Standing perk visits stay on the walking grid beside nearby furniture. See coffee trips and standups in a furnished office.
...
- ★ **Sledgehammer**: someone fetches the sledgehammer, shoulders it and takes the shorter clear route to a visible far wall; on "Knock them down" they swing and dust bursts off the wall; otherwise they carry nothing back. `id: hammer` `id: open_plan_office` `find.js open_plan_office --choice 0`
...
- ★ **The consultants**: two consultants in suits and glasses, one seated interviewing, one standing with a clipboard, with a nervous colleague facing the seated consultant while keeping their face visible to the player. `id: visitor` `id: efficiency_consultants` `capture nods-consultants`
