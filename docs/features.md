...
- ★ **Sledgehammer**: someone fetches the sledgehammer, carries it clear of their torso and holds it beside their head while sizing up the back wall; on "Knock them down" they swing and dust bursts off the wall; otherwise they carry nothing back. `id: hammer` `id: open_plan_office` `find.js open_plan_office --choice 0`
