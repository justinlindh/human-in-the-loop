...
export const EPILOGUES = [
  ...
  { id: 'clean_code', when: (s, x) => x.debt < 15,
  ...
  { id: 'humans_everywhere', when: (s) => Object.values(s.automation).every((a) => a.level === 0),
  ...
  { id: 'happy_team', when: (s, x) => x.avgMeaning >= 70,
