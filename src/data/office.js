...
// worth: cash plus twelve times MRR).
export const OFFICE_STAGES = [
  { id: 'garage', name: 'Garage', rent: 300, upgradeCost: 0, grid: { w: 9, h: 7 }, door: { x: 4, y: 6 }, blocked: [[8, 0]] },
  { id: 'floor', name: 'Office Floor', rent: 3500, upgradeCost: 60000, gate: { week: 104, launches: 2, staff: 6, brand: 15, worth: 1800000 }, grid: { w: 15, h: 12 }, door: { x: 7, y: 11 }, blocked: [[5, 4], [9, 4], [5, 8], [9, 8]] },
