...
export const OFFICE_STAGES = [
  ...
  { id: 'floor', name: 'Office Floor', rent: 3500, upgradeCost: 60000, gate: { week: 104, launches: 2, staff: 6, brand: 15 }, grid: { w: 15, h: 12 }, door: { x: 7, y: 11 }, blocked: [[5, 4], [9, 4], [5, 8], [9, 8]] },
  { id: 'hq', name: 'HQ Building', rent: 14000, upgradeCost: 750000, gate: { week: 260, liveProducts: 3, staff: 12, brand: 35 }, grid: { w: 21, h: 16 }, door: { x: 10, y: 15 }, blocked: [[6, 5], [14, 5], [6, 10], [14, 10]] },
];
