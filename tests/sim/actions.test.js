...
const PLAN_ORDER = [
  ['calendar-start', 10], ['ladder', 11], ['standup', 12], ['purpose', 13], ['beats', 14], ['work', 20], ['projects', 30], ['products', 40], ['marketing', 45], ['vacation', 48], ['strain', 49], ['meaning', 50], ['incentives', 51], ['move-on', 52], ['attrition', 53],
...
describe('system order', () => {
  it('registered systems match the plan order table', () => {
    ...
    expect(got.map(([n]) => n)).toEqual(['calendar-start', 'ladder', 'standup', 'purpose', 'beats', 'work', 'projects', 'products', 'marketing', 'vacation', 'strain', 'meaning', 'incentives', 'move-on', 'attrition', 'knowledge', 'market', 'for-sale', 'incidents', 'events', 'annual', 'economy', 'staff-upkeep', 'unlocks', 'goals', 'chat', 'endgame', 'history']);
  });
});
