...
describe('system order', () => {
  it('registered systems match the plan order table', () => {
    ...
    expect(got.map(([n]) => n)).toEqual(['calendar-start', 'standup', 'work', 'projects', 'products', 'marketing', 'meaning', 'knowledge', 'market', 'incidents', 'events', 'annual', 'economy', 'staff-upkeep', 'chat', 'endgame', 'history']);
  });
});
