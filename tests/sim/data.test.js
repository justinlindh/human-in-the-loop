...
describe('content data', () => {
  ...
  it('policies have an unlock function', () => {
    ...
    expect(Object.keys(POLICIES).sort()).toEqual(['apprenticeship', 'async_standups', 'blameless', 'comprehension_reviews', 'craft_fridays', 'crunch', 'daily_standups', 'incentives', 'no_crunch', 'pair', 'sabbatical']);
  });
